...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/eptan/crisis-inbox/blob/person-b-training/notebooks/crisisinbox_grpo_simple.ipynb)

### Steps to Train

1. **Open the notebook in Colab**
   ```
   https://colab.research.google.com/github/eptan/crisis-inbox/blob/person-b-training/notebooks/crisisinbox_grpo_simple.ipynb
   ```
